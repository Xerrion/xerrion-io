...
test.describe('About Page', () => {
  ...
  test('should have charlie section with gallery link', async ({ page }) => {
    const charlieSection = page.locator('.about-section', {
      hasText: 'Charlie'
    })
  ...
  test('should have outside of work section with 4 list items', async ({
    page
  }) => {
    const outsideSection = page.locator('.about-section', {
      hasText: 'Outside of work'
    })
    await expect(outsideSection.locator('ul li')).toHaveCount(4)
  })

  test('should have say hi section with social links', async ({ page }) => {
    const sayHiSection = page.locator('.about-section', {
      hasText: 'Say hi'
    })
