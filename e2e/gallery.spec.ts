...
test.describe('Gallery Page', () => {
  ...
  test('Category Filtering: can filter photos by category', async ({
    page
  }) => {
  ...
  test('Photo Grid: items have correct structure and labels', async ({
    page
  }) => {
  ...
  test('Lightbox: Open, navigate and close via UI and Keyboard', async ({
    page
  }) => {
