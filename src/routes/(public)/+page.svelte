...
<section class="hero">
  <div class="container">
    <div class="hero-content">
      ...
      <h1 use:fadeInUp={{ duration: 500, delay: 80 }}>
        Hey, I'm <span class="highlight">Lasse</span>
      </h1>
      ...
      <p class="intro" use:fadeInUp={{ duration: 500, delay: 240 }}>
        I build things with code, take way too many photos of my golden
        retriever Charlie, and have strong opinions about TypeScript. Currently
        making internal tools at TV 2 Danmark.
      </p>
  ...
  <div class="container">
    <div class="nav-cards" use:stagger={{ staggerDelay: 100, duration: 500 }}>
      <a href="/about" class="nav-card">
        ...
        <h2>About Me</h2>
        <p>The slightly longer version of who I am and what I do.</p>
      </a>
      <a href="/projects" class="nav-card">
        <span class="card-emoji">🛠️</span>
        <h2>Projects</h2>
        <p>Stuff I've built, mostly on GitHub. Some of it even works.</p>
      </a>
      <a href="/gallery" class="nav-card">
        <span class="card-emoji">📸</span>
        <h2>Gallery</h2>
        <p>Photos of Charlie, food, and random life moments.</p>
      </a>
    </div>
  </div>
</section>
...
<section class="currently section">
  <div class="container">
    ...
    >
      ...
      <li>
        <span class="status-icon">🦀</span>
        <span>Learning more Rust (it's fun, I promise)</span>
      </li>
      <li>
        <span class="status-icon">🐕</span>
        <span>Walking Charlie and listening to podcasts</span>
      </li>
      <li>
        <span class="status-icon">🎮</span>
        <span>Gaming when there's time</span>
      </li>
    </ul>
  </div>
</section>
