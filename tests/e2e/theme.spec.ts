...
test.describe('Theme Toggle', () => {
  test('theme toggle button exists and has correct aria-label', async ({
    page
  }) => {
    await page.goto('/')
  ...
  test('theme toggle button shows sun icon when dark theme is active', async ({
    page
  }) => {
  ...
  test('respects system light preference when no localStorage', async ({
    page
  }) => {
