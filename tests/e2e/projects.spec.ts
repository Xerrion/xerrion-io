...
test.describe('Projects Page', () => {
  ...
  test('should load and display basic page elements', async ({ page }) => {
    ...
    await expect(languageSelect.locator('option').first()).toHaveText(
      'All languages'
    )
  ...
  test('should display project cards with expected elements', async ({
    page
  }) => {
  ...
  test('should show empty state for no results and allow reset', async ({
    page
  }) => {
    const searchInput = page.locator('.search-input')
